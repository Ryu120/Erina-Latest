...
RAIDEN_IMG = "https://telegra.ph/file/02b39b4471001e2ae6802.mp4"
RAIDEN_START = "https://telegra.ph/file/a65a501d9cdb9e31729d9.mp4"
...
buttons = [
    [
        InlineKeyboardButton(
            text="➕️ ᴀᴅᴅ ᴇʀɪɴᴀ ᴛᴏ ʏᴏᴜʀ ɢʀᴏᴜᴘ ➕️",
            url="t.me/Erina_GroupBot?startgroup=true",
        ),
    ],
    [
        InlineKeyboardButton(
            text="ᴍʏ ʜᴏᴍᴇ",
            url="t.me/ErinaSupport",
        ),
        InlineKeyboardButton(
            text="xᴏʟᴛɪᴄ ʜᴇʟʟ",
            url="https://t.me/Xoltic_hell",
        ),
    ],
    [
        InlineKeyboardButton(
        ...
        InlineKeyboardButton(
            text="ᴇᴍᴘᴇʀᴏʀ",
            url="https://t.me/xoltic",
        ),
    ],
]

HELP_STRINGS = """
Hey there! Myself [ᴇʀɪɴᴀ](https://telegra.ph/file/fc360b144faa9ed97bf48.jpg).
...
*Main* commands available:
 ...
 ➛ /settings: 
   ...
   ❂ in a group: will redirect you to pm, with all that chat's settings.\n• *ʀᴇᴀᴄʜ ᴏᴜᴛ ғᴏʀ sᴜᴘᴘᴏʀᴛ:* [sᴜᴘᴘᴏʀᴛ](https://t.me/ErinaSupport)
"""
            ...
            reply_markup=InlineKeyboardMarkup(
                [
                    [
                        InlineKeyboardButton(
                            text="ᴍʏ ʜᴏᴍᴇ",
                            url="https://t.me/ErinaSupport",
                        ),
                        InlineKeyboardButton(
                            text="ʜᴇʟᴘ",
                            url=f"https://t.me/Erina_GroupBot?start=help",
                        ),
                    ]
                ]
            ),
    ...
    if SUPPORT_CHAT is not None and isinstance(SUPPORT_CHAT, str):
        try:
            dispatcher.bot.send_video(
                "@ErinaSupport",
                "https://telegra.ph/file/a73af7762067bb6bcc331.jpg",
                "Ready To Buzz ~ UwU ~",
                parse_mode=ParseMode.MARKDOWN,
            )
        except Unauthorized:

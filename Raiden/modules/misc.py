...
def info(update, context):
    ...
    if user.id == OWNER_ID:
        text += ("\n\n» This person is a appointed <b>'Director'</b>.")
        disaster_level_present = True
    elif user.id in DEMONS:
        text += ("\n\n» This person is a appointed <b>'Second Seat'</b>.")
        disaster_level_present = True
    elif user.id in DEV_USERS:
        text += ("\n\n» This person is a appointed <b>'Elite Ten Council'</b>.")
        disaster_level_present = True
    elif user.id in SUPPORT_USERS:
        text += (
            "\n\n » This person is a appointed <b>'First Seat'</b>"
        )
        disaster_level_present = True
    elif user.id in WHITELIST_USERS:
        text += (
            "\n\n » This person is a appointed <b>'Top Chef'</b>"
        )
        disaster_level_present = True
            ...
            photo=profile,
                ...
                reply_markup=InlineKeyboardMarkup(
                    [
                        [
                            InlineKeyboardButton(
                                "Support", url="https://t.me/ErinaSupport"),
                            InlineKeyboardButton(
                                "Disaster", url="https://t.me/ErinaUpdates"),
                         ],
                         [
                            InlineKeyboardButton(
        ...
        msg.reply_text(
                reply_markup=InlineKeyboardMarkup(
                    [
                        [
                            InlineKeyboardButton(
                                "Support", url="https://t.me/Erina_GroupBot"),
                            InlineKeyboardButton(
                                "Disaster", url="https://t.me/ErinaUpdates"),
                         ],
                         [
